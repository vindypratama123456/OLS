$(function() {
    ...
    $("#main-nav > li > ul > li > a").each(function(){
        $(this).prepend(' &raquo;&nbsp; ');
        if($(this).attr("href") == BASE_URL+pgurl) {
...
function initDatatables(element) {
    ...
    dataTables = element.DataTable({
        ...
        'columnDefs': table_defs.columnDefs,
        'language': {
            'url': BASE_URL+'assets/backmin/js/plugins/datatables/Indonesian.json'
        },
