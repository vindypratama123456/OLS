...
function panel_refresh(panel,action,callback){        
    if(!panel.hasClass("panel-refreshing")){
        var my_loader = '<img src="'+BASE_URL+'assets/img/loaders/default.gif"/>';
        panel.append('<div class="panel-refresh-layer" style="z-index:9999;">'+my_loader+'</div>');
...
function x_navigation(){
    ...
    $(".x-navigation-minimize").click(function(){
        ...
        if($(".page-sidebar .x-navigation").hasClass("x-navigation-minimized")){
            ...
            Cookies.set('viewmore', true);
        }else{            
            $(".page-container").addClass("page-navigation-toggled");
            x_navigation_minimize("close");            
            Cookies.set('viewmore', false);
        }
...
function pageLoadingFrame(action,ver){    
    ...
    loader['v1'] = '<div class="page-loading-loader"><img src="'+BASE_URL+'assets/img/loaders/page-loader.gif"/></div>';
...
function loading_button(id){
    $("#"+id).prop("disabled", true);
    $("#"+id).text("Loading...");
}

function reset_button(id, text){
...
$(document).ready(function(){
    $('#confirm-delete').on('click', '.btn-ok', function(e) {
        ...
        var uri = $(this).data('recordUri');
        var mylist = $(this).data('recordList');
        var myid = $(this).data('recordId');
        loading_button("destroy");
        $.ajax({
            data: { id: myid },
            dataType: "json",
            type: "POST",
            ...
            success: function(e){
                if(e.success=="true") {
                    alert( "Data #" + myid + " berhasil dihapus." );
                    window.location.href = BASE_URL+mylist;
                }
                else {
                    alert("Gagal menghapus data :(");
                    reset_button("destroy", "Delete");
                    $modalDiv.hide();
                    return false;
                }
            }
    ...
    $('#confirm-delete').on('show.bs.modal', function(e) {
        ...
        $('.btn-ok', this).data('recordUri', data.recordUri);
        $('.btn-ok', this).data('recordList', data.recordList);
    });
});
