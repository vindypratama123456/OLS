$(document).ready(function(){
    ...
    if ($('#datatableProduct').length>0){
        ...
        datas['url'] = BASE_URL + BACKMIN_PATH + 'product/listProduct';
        datas['columns'] = [
            { 'data': 'kode_buku' },
            { 'data': 'reference' },
            { 'data': 'category' },
    ...
    function install()
    {
                ...
                var uri43 = BASE_URI + 'home/generateJsonSmartLibrary/1-6';
                var uri44 = BASE_URI + 'home/generateJsonSmartLibrary/7-9';
                var uri45 = BASE_URI + 'home/generateJsonSmartLibrary/10-12';
                ...
                function req42(){
                    $.ajax({
                        ...
                        success: function(e42){
                            ...
                            $("#alert").append("42. " + e41.message + " <b>OK</b> <br/>");
                            req43();
                        }
                    });
                }
