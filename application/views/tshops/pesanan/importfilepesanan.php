        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row userInfo">
                <div class="col-xs-12 col-sm-12">
                    ...
                    <br /><br />
                    <p>Silahkan impor file excel yang telah anda download</p>
                    <?php echo form_open(base_url() . 'pesanan/konfirmasipesananupload', 'name="import_file_pesanan" enctype="multipart/form-data" method="post"'); ?>
