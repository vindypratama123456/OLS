                ...
                <div class="form-group">
                    <div class="col-md-8"><br />
                        ...
                        <label class="radio-inline">
                            <input name="active" value="1" type="radio"<?php if ($detil['active']==1) { echo ' checked'; } ?>>Ya
                        </label>
                        <label class="radio-inline">
                            <input name="active" value="0" type="radio"<?php if ($detil['active']==0) { echo ' checked'; } ?>>Tidak
                        </label>
                    </div>
                </div>
                <div class="form-group">
