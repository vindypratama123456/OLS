<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php echo form_open('', 'data-action="' . base_url() . ADMIN_PATH . '/region/editPost" id="region_form" autocomplete="off"'); ?>

                <input type="hidden" name="id_group" value="<?=$detil['id_group']?>" />
