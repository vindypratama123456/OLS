...
<html>
    ...
    <body onload="window.print();">
        ...
        <div align="center">
            ...
            <span class="judul-2">BUKU <?php echo strtoupper($listproducts[0]->type . ' (' . $listproducts[0]->type_alias . ')'); ?></span><br />
            <p>No. <b>#<?php echo $detil['reference']; ?></b></p>
        </div>
        <p style="margin:40px 0 10px 0;">Pada hari ini, .............. Tanggal: ...... Bulan: ...... Tahun: ...... yang bertanda tangan di bawah ini:</p>
        ...
        <p>Selanjutnya berdasarkan Surat Pemesanan <?php echo $listproducts[0]->type . ' (' . $listproducts[0]->type_alias . ')'; ?> pada TANGGAL: .............. PIHAK KESATU Menyerahkan Buku Kurikulum Tahun 2013 kepada PIHAK KEDUA dengan perincian sbb:</p>
        ...
        <p style="margin-bottom:50px;">Barang sebagaimana disebut diatas telah diterima dalam keadaan baik oleh PIHAK KEDUA.<br />Demikian Berita Acara Serah Terima <?php echo $listproducts[0]->type . ' (' . $listproducts[0]->type_alias . ')'; ?> ini dibuat dengan sebenarnya dalam rangkap 5 (lima) untuk dapat dipergunakan sebagaimana mestinya.</p>
