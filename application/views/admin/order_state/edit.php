<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php echo form_open('', 'data-action="' . base_url() . ADMIN_PATH . '/order_state/editPost" id="order_state_form" autocomplete="off"'); ?>

                <input type="hidden" name="id_order_state" value="<?=$detil['id_order_state']?>" />
