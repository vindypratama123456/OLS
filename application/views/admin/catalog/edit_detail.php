        ...
        <div class="col-lg-12">
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" value="<?= toRupiah($detil['product_price']) ?>" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <label>Diskon</label>
                    <input type="text" class="form-control" name="reduction_percent" id="reduction_percent"
                           value="<?= $detil['reduction_percent'] ?>" readonly>
                </div>
            </div>
