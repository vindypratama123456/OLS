    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h4>Detail Proses Approval</h4></div>
            ...
            <!-- <a href="<?php echo base_url(ADMIN_PATH.'/steam/proses_sap_post/'.$payout_comission[0]->sap_no); ?>" class="btn btn-warning btn pull-left" id="print_excel1" style="margin-left:8px;">Proses SAP</a> -->
            <a href="#" class="btn btn-warning btn pull-left btn-pilih" data-sapno="<?php echo $payout_comission[0]->sap_no; ?>" id="print_excel1" style="margin-left:8px;">Proses SAP</a>
            <a href="#" class="btn btn-warning pull-left" id="print_excel1" style="margin-left:8px;" onclick="return printKomisi('<?php echo $payout_comission[0]->sap_no; ?>');">Cetak</a>
            <a href="<?php echo $url_back; ?>" class="btn btn-primary pull-right">Kembali</a>
        </div>
...
<script type="text/javascript">
    ...
    function printKomisi(sap_no){
        window.open('<?php echo base_url(ADMIN_PATH . '/steam/cetak_komisi/'); ?>' + sap_no, 'page', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=750,height=600,left=50,top=50,titlebar=no');
    }
</script>
