    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h4>Transfer Dana Komisi</h4></div>
                <div class="panel-body">
                    <ul class="list-group">
                        <li class="list-group-item">
                            No. Pesanan Dana: <b><?php echo $payout_comission[0]->no_pd; ?></b><br>
                            Tanggal Transfer: <?php echo ($payout_comission[0]->transfer_date == '0000-00-00') ? '-' :
                                tgl_indo($payout_comission[0]->transfer_date, 5); ?>
                            <?php
                        ...
                        ?>
                        <li class="list-group-item">
                            <button class="btn btn-lg btn-success" id="btn-posting" data-no-pd="<?php echo $payout_comission[0]->no_pd; ?>" style="margin-top:5px;">
                            ...
                            <button class="btn btn-lg btn-success" id="btn-bayar-pdfailed" data-no-pd="<?php echo $payout_comission[0]->no_pd; ?>" style="margin-top:5px;">
                        ...
                        <table class="table dt-responsive table-bordered">
                            <thead class="background-head">
                                <tr class="text-head">
                                    ...
                                    <th class="text-center">Total Ditransfer</th>
                            ...
                            ?>
                                <tr>
                                    <td colspan="6" class="text-center">T O T A L </td>
            ...
            <a href="#" class="btn btn-warning btn-lg pull-left" style="margin-left:8px;" onclick="printPesananDana()">Cetak</a>
