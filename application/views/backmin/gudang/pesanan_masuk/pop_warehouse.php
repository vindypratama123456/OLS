                ...
                <tbody
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if($row->status == 1) { ?>
                            <a href="<?php echo base_url(BACKMIN_PATH.'/gudangpesanan/detailPesananForward/'.$id_transaksi.'/'.$row->id_gudang); ?>" class="btn btn-default btn-rounded btn-condensed btn-sm pilih_gudang"><span class="fa fa-check"></span></a>
