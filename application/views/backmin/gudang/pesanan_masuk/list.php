...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo base_url(BACKMIN_PATH.'/gudangpesanan'); ?>">Pesanan</a></li>
...
<div class="page-title">                    
    ...
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu">
            <li><a href="#" onClick ="$('#tableListPesananMasuk').tableExport({type:'excel',escape:'false'});"><img src='<?php echo image_export(); ?>xls.png' width="24"/> XLS</a></li>
        </ul>
    </div>
</div>
<!-- END PAGE TITLE -->                
                        ...
                        <table class="display table table-striped responsive datatable data-table" data-table-def="tableListPesananMasuk" id="tableListPesananMasuk" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Tanggal Logistik</th>
