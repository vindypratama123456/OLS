        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <p>
                        ...
                        <?php 
                            if($detail['kirim_parsial_accept_by_id'] != null || $detail['kirim_parsial_accept_by_id'] != "")
                            {
                                ...
                                {
                                    echo '<h3>'.$status_parsial['status_transaksi'].'</h3>';   
                                }
                            }
                            else
                            {
                    ...
                    ?>
                    <?php 
                            if($detail['file_bast'] != null || $detail['file_bast'] != "") 
                            { 
                    ?>
                                <h6>File BAST</h6>
                    ...
                    <?php 
                        ...
                        {
                            if($transaksi->status_transaksi == 6) 
                            { 
                    ?>
                    <h6>File BAST</h6>
                    <div class="gallery" id="links">
                        ...
                        ?>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Bukti BAST</label>
                                        <div class="col-md-6">
                                            <div class="photo">
