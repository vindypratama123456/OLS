...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo base_url(BACKMIN_PATH.'/gudangpermintaanpartial/indexBarangMasuk'); ?>">Permintaan</a></li>
    <li><a href="<?php echo base_url(BACKMIN_PATH.'/gudangpermintaanpartial/indexBarangMasuk'); ?>">Barang Masuk</a></li>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body panel-body-table">
                    <?php echo form_open('', 'id="frmDetilBarangMasuk" class="form-horizontal" data-uri="' . BACKMIN_PATH . '/gudangpermintaanpartial/prosesBarangMasuk" role="form" autocomplete="off"'); ?>
                        ...
                        <div class="form-group panel-footer">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo base_url(BACKMIN_PATH.'/gudangpermintaanpartial/indexBarangMasuk'); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
