...
<div class="page-content-wrap">
    <div class="row">                        
        <div class="col-md-12">
            ...
            <?php echo form_open(base_url(BACKMIN_PATH.'/gudangrequeststockpartial/addConfirmation'), 'id="frmRequestStock" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" autocomplete="off"'); ?>
                ...
                <div class="panel panel-default">
                    <input type="hidden" value="1" name="is_tag" class="is_tag">
