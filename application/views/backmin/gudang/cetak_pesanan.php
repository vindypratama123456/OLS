...
<html moznomarginboxes mozdisallowselectionprint>
    ...
    <body onload="window.print();">
        <div id="logo-content">
			...
			<?php if ($detail['date_add'] < '2019-01-01' ) { ?>
        ...
        <table class="table-products" border="1" border-collapse="collapse" width="100%">
            ...
            <?php 
                ...
                $tot_koli_utuh += $koli_utuh;
                } 
            ?>
                <tr>
                    <td colspan="3"><strong><center>Jumlah</center></strong></td>
                    <td><center><strong><?php echo $tot_item; ?> Eks</strong></center></td>
                    <td colspan="4"></td>
                </tr>
                <tr>
                    <td colspan="3"><strong><center>Jumlah Koli Utuh</center></strong></td>
                    <td><center><strong><?php echo $tot_koli_utuh; ?> Koli</strong></center></td>
                    <td colspan="4"></td>
                </tr>
                <tr>
