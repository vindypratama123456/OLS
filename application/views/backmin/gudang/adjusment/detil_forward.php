    ...
    <div class="row">                        
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                ...
                <?php echo form_open('', 'id="frmDetilPesananForward" class="form-horizontal" data-uri="' . BACKMIN_PATH . '/gudangpesanan/processPesananForward" role="form" autocomplete="off"'); ?>
                <div class="panel-body panel-body-table">
                    ...
                    <input type="hidden" name="id_pesanan" value="<?php echo $transaksi->id_pesanan; ?>">
                    <input type="hidden" name="kode_pesanan" value="<?php echo $transaksi->kode_pesanan; ?>">
                    ...
                    <div class="table-responsive" id="product-area">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <input type="hidden" name="is_tag[]" value="<?php echo $is_tag; ?>">
                                <?php 
                                        $i++;
                ...
                <div class="form-group panel-footer">
                    <?php if($is_waiting > 0) { ?>
                        <p><i class="glyphicon glyphicon-info-sign"></i>&nbsp;&nbsp;<b>Kekurangan barang yang ada pada gudang yang dituju akan dikirim oleh gudang yang menunjuk gudang tersebut.</b></p>
                    <?php } ?>
                    <div class="pull-left">
                        <button class="btn btn-success" id="submitDetail">L a n j u t k a n</button>
                    </div>  
                    <div class="pull-right">
                        <a href="<?php echo base_url(BACKMIN_PATH.'/gudangpesanan/detailPesananMasuk/'.$detail['id_order']); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
