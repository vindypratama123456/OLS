...
<div class="page-content-wrap">
    <div class="row">                        
        <div class="col-md-12">
            ...
            <?php echo form_open('', 'id="frmContinueRequestStock" class="form-horizontal" data-uri="' . BACKMIN_PATH . '/gudangreceiving/addConfirmationPost" role="form" autocomplete="off"'); ?>
