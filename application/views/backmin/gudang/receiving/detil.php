...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo base_url(BACKMIN_PATH.'/gudangrequeststock'); ?>">Stock Receiving</a></li>
    <li class="active">Detail Data</li>
</ul>
<!-- END BREADCRUMB -->
<!-- PAGE TITLE -->
<div class="page-title">                    
    <h2><span class="glyphicon glyphicon-bookmark"></span> Detail Stock Receiving</h2>
</div>
<!-- END PAGE TITLE -->                
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Info Gudang Receiving</h3>
                ...
                <div class="panel-body">
                    ...
                    <h6>Status</h6>
                    <p>Status Receiving : <?php echo $status; ?><br>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="13%">No. OEF</th>
                                ...
                                <tbody>
                                    ...
                                    <tr id="trow_<?php echo $i; ?>">
                                        ...
                                        <td class="text-center"><?php echo $row->no_oef; ?></td>
