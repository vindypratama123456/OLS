<ul class="breadcrumb">
    ...
    <li class="active">Stock Receiving</li>
</ul>

<div class="page-title">
    <h2><span class="glyphicon glyphicon-bookmark"></span> List Stock Receiving</h2>
    <a href="<?php echo base_url(BACKMIN_PATH . '/gudangreceiving/add'); ?>" class="btn btn-success" style="float: right;">
        <span class="glyphicon glyphicon-plus"></span> Buat Stock Receiving
    </a>
</div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="display table table-striped responsive datatable data-table" data-table-def="tableListRequestStock" id="tableListRequestStock" width="100%">
                            <thead>
                                <tr>
                                    <th class="text-center" width="10%">ID Receiving</th>
