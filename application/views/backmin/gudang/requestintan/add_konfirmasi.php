...
<div class="page-title">                    
    <h2><span class="glyphicon glyphicon-bookmark"></span> Konfirmasi Permintaan Stok Intan</h2>
...
<div class="page-content-wrap">
    <div class="row">                        
        <div class="col-md-12">
            ...
            <?php echo form_open('', 'id="frmContinueRequestIntan" class="form-horizontal" data-uri="' . BACKMIN_PATH . '/gudangrequestintan/prosesAddRequestIntan" role="form" autocomplete="off"'); ?>
                ...
                <div class="panel panel-default">
                    <div class="form-group panel-footer">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo base_url(BACKMIN_PATH.'/gudangrequestintan/add'); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                        </div>
                    </div>
                </div>
                <br />
