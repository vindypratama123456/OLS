        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title pull-right">Rekomendasi: <b><?php echo $recommended_warehouse->nama_gudang; ?></b></h3>
                </div>
                <div class="panel-body panel-body-table">
                    <?php echo form_open('', 'id="frmDetilPesananMasuk" class="form-horizontal" data-uri="' . BACKMIN_PATH . '/scmpesanan/processPesananMasuk" role="form" autocomplete="off"'); ?>
                        ...
                        <input type="hidden" name="gudang_asal" value="<?php echo $recommended_warehouse->id_gudang; ?>">
                        ...
                        <div class="form-group panel-footer">
                            <div class="pull-left">
                                ...
                                <?php } ?>
                                <p id="avaiableMessage">Menunggu gudang rekomendasi melakukan pemenuhan stok untuk pesanan ini.</p>
                                <a href="#" class="btn btn-warning" style="margin-left:10px;" onclick="printPesanan();">Cetak Pesanan</a>
                                <?php } ?>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo base_url(BACKMIN_PATH.'/scmpesanan/indexPesananMasuk'); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    <?php echo form_close(); ?>
                </div>
