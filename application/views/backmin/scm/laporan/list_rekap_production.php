        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <?php echo form_open('', 'id="formExportRekapProduction" class="form-horizontal" data-uri="' . BACKMIN_PATH . '/gudangproduction/cetakProductionReport" role="form" autocomplete="off"'); ?>
