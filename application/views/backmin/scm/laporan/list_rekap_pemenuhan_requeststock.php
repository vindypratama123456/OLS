...
<ul class="breadcrumb">
    ...
    <li class="active">Rekapitulasi Pemenuhan Permintaan Stock</li>
</ul>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <?php echo form_open('', 'id="formExportRekapRequest" class="form-horizontal" data-uri="' . BACKMIN_PATH . '/scmrequeststockpartial/cetakRekapitulasiPemenuhanRequestStock" role="form" autocomplete="off"'); ?>
