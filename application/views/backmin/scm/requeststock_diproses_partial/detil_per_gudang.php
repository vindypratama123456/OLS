                    ...
                    <?php echo form_open('', 'id="frmDetilPermintaanStok" class="form-horizontal" role="form" autocomplete="off"'); ?>
                        ...
                        <div class="form-group panel-footer">
                            <div class="pull-right">
                                <?php 
                                    if ($status_request['status'] == 1)
                                    {
                                ?>
                                        <a href="<?php echo base_url(BACKMIN_PATH.'/scmrequeststockpartial/detailRequestStockMasuk/'. $detail['id_request']); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                        <a href="<?php echo base_url(BACKMIN_PATH.'/scmrequeststockpartial/detailRequestStockDiproses/'. $detail['id_request']); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                                <?php
                                    }
                                ?>
                            </div>
