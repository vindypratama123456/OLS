...
<ul class="breadcrumb">
    ...
    <li class="active">Permintaan Diproses</li>
</ul>
<!-- END BREADCRUMB -->
<!-- PAGE TITLE -->
<div class="page-title">                    
    <h2><span class="glyphicon glyphicon-bookmark"></span> List Permintaan Stok Diproses</h2>
    <div class="btn-group pull-right">
        <button class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export Data</button>
        <ul class="dropdown-menu">
            <li><a href="#" onClick="$('#tableListRequestStock').tableExport({type:'excel',escape:'false'});"><img src='<?php echo image_export(); ?>xls.png' width="24"/> XLS</a></li>
        </ul>
    </div>
</div>
<!-- END PAGE TITLE -->                
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <table class="table table-striped dt-responsive nowrap" id="tableListRequestStock">
                            <thead>
                                <tr>
                                    <th class="text-center" width="10%">ID Request</th>
                                    <!-- <th class="text-center" width="15%">Gudang Pengirim</th> -->
                                    <th class="text-center" width="15%">Gudang Request</th>
                                    ...
                                    <th class="text-center" width="10%">Pesanan Intan</th>
