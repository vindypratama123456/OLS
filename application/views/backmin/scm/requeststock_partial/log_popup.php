...
<div class="modal-body">
    <div class="row">
        <div class="col-lg-12">
            <input type="hidden" name="id_request" value="<?= $detil['id_request'] ?>"/>
            <div class="form-group">
                <div class="col-sm-12">
                    <label>Tuliskan Log Book</label>
            ...
            if (notes !== '') {
                ...
                if (conf) {
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        url: BASE_URL + 'backmin/scmrequeststockpartial/logPost',
                        success: function (datas) {
                            // console.log(datas.message);
                            // console.log(BASE_URL + 'backmin/scmrequeststockpartial/detailRequestStockMasuk/' + "<?= $detil['id_request'] ?>");
                            if (datas.success == 'true') {
                                window.location.href = BASE_URL + 'backmin/scmrequeststockpartial/detailRequestStockMasuk/' + "<?= $detil['id_request'] ?>";
                            } else {
