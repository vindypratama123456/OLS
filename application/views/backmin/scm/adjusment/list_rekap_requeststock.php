        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <?php echo form_open('', 'id="formExportRekapRequest" class="form-horizontal" data-uri="' . BACKMIN_PATH . '/scmadjusment/cetak_rekapitulasi_adjusment" role="form" autocomplete="off"'); ?>
