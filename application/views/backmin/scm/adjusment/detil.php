...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo base_url(BACKMIN_PATH.'/scmadjusment/index_adjusment'); ?>">Adjustment</a></li>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr id="trow_<?php echo $i; ?>">
                                        ...
                                        <a data-toggle="modal" href="<?php echo base_url(BACKMIN_PATH.'/scmadjusment/edit/'.$row->id.'/'.$row->jumlah); ?>" data-target="#myModal">Ubah</a>
                                        </th>
                                        <?php } ?>
                                    </tr>
                                    <?php 
                        ...
                        <div class="form-group panel-footer">
                            ...
                            <div class="pull-right">
                                <?php if ($detil['current_state'] = 1) { ?>
                                    <a href="<?php echo base_url(BACKMIN_PATH.'/scmadjusment/add_books/'.$adjusment[0]->id_transaksi); ?>" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-square"></i> Tambah Buku</a>
                                <?php } ?>
                                <a href="<?php echo base_url(BACKMIN_PATH.'/scmadjusment/index_adjusment'); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    <?php echo form_close(); ?>
                </div>
